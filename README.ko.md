...
- **클라우드 제공자:** OpenAI, Anthropic, Google (Gemini), xAI (Grok), DeepSeek, Mistral, Groq, OpenRouter, Alibaba (DashScope), Z.AI (GLM)
...
- `all` — 구성된 API 키를 보유한 모든 클라우드 모델(로컬 모델 및 OpenRouter 제외). 많은 모델로 확장될 수 있으므로 `--max-cost`와 함께 사용하십시오.
